...
function statusCopy(status) {
  return {
    available: ['Готов и ждёт встречи', 'status--available'],
...
function residentCard(resident) {
  ...
  const actions = resident.availability === 'available'
    ? `<a class="button button--wine button--compact" href="/contact.html?resident=${encodeURIComponent(resident.slug)}">Забрать себе</a>`
